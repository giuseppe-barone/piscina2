...
public class InserimentoFallito extends JDialog {
	...
	public static void main(String[] args) {
		try {
			InserimentoFallito dialog = new InserimentoFallito();
	...
	public InserimentoFallito() {
		...
		JLabel lblInserimentoAvvenutoCon = new JLabel("OPERAZIONE DI INSERIMENTO FALLITA");
